...
export const Modal = ({
  ...
  // не рендерим модалку до маунта: на узком десктоп-окне useIsMobile отдаёт
  // false на первом кадре, и панель успевала смонтироваться десктопной, а потом
  // переехать в мобильную ветку — анимация enter застревала на opacity≈0.
  ...
  // блок скролла — через общий ref-count хук (безопасно при нескольких оверлеях)
